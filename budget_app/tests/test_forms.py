...
class TestForms:
    ...
    def test_budget_creation_form_with_valid_data(self, client, test_user_login):
    ...
    def test_budget_creation_form_without_name(self, client, test_user_login):
        _ = test_user_login
    ...
    def test_budget_creation_form_without_balance(self, client, test_user_login):
        _ = test_user_login
    ...
    def test_budget_creation_form_with_invalid_balance(self, client, test_user_login):
        _ = test_user_login
        form_data = {'name': 'TestBudget', 'balance': -1000}
        response = client.post(reverse('new_budget'), form_data)
    ...
    def test_budget_creation_form_with_existing_name(self, client, test_user_login):
        _ = test_user_login
        form_data = {'name': 'TestBudget', 'balance': 1000}
        response = client.post(reverse('new_budget'), form_data)
    ...
    def test_budget_creation_form_with_too_short_name(self, client, test_user_login):
        _ = test_user_login
